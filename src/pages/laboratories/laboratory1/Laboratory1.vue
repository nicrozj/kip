      ...
      <div class="flex flex-col gap-2 w-full">
        ...
        >
          ...
          <div class="flex flex-col gap-4 h-max">
            ...
            <button
              @click="runScript(task)"
              @mouseover.stop
              class="rounded-lg px-4 py-2 bg-gray-200 border-[1px] border-gray-300"
            >
              Запустить
            </button>
          </div>
        ...
        >
          ...
          <div class="flex flex-col gap-4 h-max">
            ...
            <div class="flex gap-4 h-max items-center">
              <button @click="counter--" class="bg-gray-200 rounded-lg p-2">
                -
              </button>
              {{ counter }}
              <button @click="counter++" class="bg-gray-200 rounded-lg p-2">
