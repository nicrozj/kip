...
function incrementCounter(counterNumber) {
    let counterElement = document.getElementById(`counter${counterNumber}`);
...
<template>
    <UPage>
        <UHeader />
        <UMain>
            <div class="text-center my-10 flex flex-col justify-center items-center bg-slate-100 p-10 rounded-lg">
                ...
                <div class="flex gap-4">
                    ...
                    <button @click="decrementCounter(2)">-</button>
                </div>
                <div class="flex gap-4">
                    <p id="counter3">0</p>
                    <button @click="incrementCounter(3)">+</button>
                </div>
                <div class="flex gap-4">
                    <h1 id="counter4">0</h1>
                    <button @click="decrementCounter(4)">-</button>
                </div>
            </div>
        </UMain>
    </UPage>
